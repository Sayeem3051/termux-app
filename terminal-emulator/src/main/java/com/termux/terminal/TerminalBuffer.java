        ...
        for (int row = selY1; row <= selY2; row++) {
            ...
            if (rowLineWrap && x2 == columns) {
                ...
                if (lastPrintingCharIndex >= x1Index && line[lastPrintingCharIndex] == ' ') {
                    ...
                    if (prevPrintingCharIndex >= x1Index) {
                        int prevCodePointIndex = Character.isLowSurrogate(line[prevPrintingCharIndex])
                            ? prevPrintingCharIndex - 1
                            : prevPrintingCharIndex;
                        if (prevCodePointIndex >= x1Index
                            && WcWidth.width(Character.codePointAt(line, prevCodePointIndex)) == 2) {
                            ...
                            if (colOfPrev == prevCodePointIndex) {
